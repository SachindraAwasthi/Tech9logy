...
class Save extends \Tech9logy\CouponCode\Controller\Adminhtml\Coupon
{
    /**
    ...
    public function execute()
    {
        ...
        if ($data) {
            try {
                /** @var $model \Tech9logy\CouponCode\Model\Coupon */
                $model = $this->_objectManager->create('Tech9logy\CouponCode\Model\Coupon');
    ...
    {
        return $this->_authorization->isAllowed('Tech9logy_CouponCode::coupon_save');
    }
}
