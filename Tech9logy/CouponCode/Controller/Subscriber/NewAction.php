 ...
 */
namespace Tech9logy\CouponCode\Controller\Subscriber;
...
use Magento\Framework\Event\ManagerInterface; // Corrected namespace
...
class NewAction extends SubscriberController implements HttpPostActionInterface
{
    ...
    public function __construct(
        ...
        ManagerInterface $eventManager, // Corrected argument type
    ) {
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            // $data = ['coupon_email' => $email];
            // $this->_eventManager->dispatch('couponcode_form_submit', ['data' => $data]);
            try {
                ...
                $subscriber = $currentCustomerId
                    ...
                    // Data to be passed to the observer
                $data = ['coupon_email' => $email];
                $this->_eventManager->dispatch('couponcode_form_submit', ['data' => $data]);
