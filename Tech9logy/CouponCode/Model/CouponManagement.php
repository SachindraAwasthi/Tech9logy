...
class CouponManagement implements CouponManagementInterface
{
    ...
    public function set($cartId, $couponCode)
    {
        ...
        $coupon_collection = $objectManager->create('Tech9logy\CouponCode\Model\Coupon')->getCollection();
    ...
    public function getCouponAlias($alias)
    {
        ...
        $coupon_model = $this->_objectManager->create('Tech9logy\CouponCode\Model\Coupon')->getCouponByAlias($alias);
    ...
    public function getCouponByConditions()
    {
        ...
        $coupon_model = $this->_objectManager->create('Tech9logy\CouponCode\Model\Coupon');
