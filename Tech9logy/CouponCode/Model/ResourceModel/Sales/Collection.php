...
namespace Tech9logy\CouponCode\Model\ResourceModel\Sales;
...
class Collection extends \Tech9logy\CouponCode\Model\ResourceModel\AbstractReport\Ordercollection
{
    ...
    public function prepareByCouponCollection()
    {
        ...
        $this->getSelect()->join(['tech9logycoupon'=>'tech9logy_couponcode_coupon'], 'tech9logycoupon.code=main_table.coupon_code', 'code');
        $this->getSelect()
