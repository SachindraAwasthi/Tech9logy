    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function __construct(
        ...
        \Tech9logy\CouponCode\Model\Action $actionModel,
        array $data = []
    ) {
    ...
    protected function addBehaviorConditions(
        \Magento\Framework\Data\Form $form,
        \Tech9logy\CouponCode\Model\Rule $model
    ) {
        $renderer = $this->_rendererFieldset
            ->setTemplate("Magento_CatalogRule::promo/fieldset.phtml")
            ->setNewChildUrl(
                $this->getUrl(
                    "sales_rule/promo_quote/newActionHtml/form/rule_actions_fieldset/form_namespace/edit_form"
                )
            );
    ...
    protected function addOrginalField(
        \Magento\Framework\Data\Form $form,
        \Tech9logy\CouponCode\Model\Rule $model
    ) {
        ...
        $fieldset->addField("simple_action", "select", [
            ...
            "name" => "simple_action",
            "options" => [
                \Magento\SalesRule\Model\Rule::BY_PERCENT_ACTION => __(
                    "Percent of product price discount"
                ),
                \Magento\SalesRule\Model\Rule::BY_FIXED_ACTION => __(
                    "Fixed amount discount"
                ),
                \Magento\SalesRule\Model\Rule::CART_FIXED_ACTION => __(
                    "Fixed amount discount for whole cart"
                ),
                \Magento\SalesRule\Model\Rule::BUY_X_GET_Y_ACTION => __(
