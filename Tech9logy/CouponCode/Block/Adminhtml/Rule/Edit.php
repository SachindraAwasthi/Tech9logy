<?php
  ...
  */
namespace Tech9logy\CouponCode\Block\Adminhtml\Rule;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Tech9logy_CouponCode::rule_save')) {
        ...
        if ($this->_isAllowedAction('Tech9logy_CouponCode::rule_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('tech9logycouponcode_rule')->getId()) {
            return __("Edit Form '%1'", $this->escapeHtml($this->_coreRegistry->registry('tech9logycouponcode_rule')->getTitle()));
        } else {
            return __('New Form');
        }
    }
...
//     {
//         $refreshUrls = [];
//         $model = $this->_coreRegistry->registry('tech9logyfollowupemail_email');
...
//         $editUrl = $this->getUrl(
//                                 'tech9logyfollowupemail/email/sendtestemail'
//                             );
//         return <<<HTML
//     <script>
