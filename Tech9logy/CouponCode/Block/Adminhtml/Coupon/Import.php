<?php
  ...
  */
namespace Tech9logy\CouponCode\Block\Adminhtml\Coupon;
...
class Import extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Tech9logy_CouponCode::coupon_import')) {
    ...
    {
        if ($this->_coreRegistry->registry('tech9logycouponcode_coupon')->getId()) {
            return __("Edit Form '%1'", $this->escapeHtml($this->_coreRegistry->registry('tech9logycouponcode_coupon')->getName()));
        } else {
            return __('New Form');
        }
    }
